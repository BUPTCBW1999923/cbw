...
Page({
  ...
  convert: function () {
    ...
    var length = app.globalData.Infrared.datapoints.length
    for (var i = 0; i < length; i++) {
      ...
      Infrared.push(app.globalData.Infrared.datapoints[i].value);
  ...
  //新建光照强度图表
    lineChart_Infrared = new myCharts({
      canvasId: 'Infrared',
      type: 'line',
      categories: wheatherData.categories,
      animation: true,
